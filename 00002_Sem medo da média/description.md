Outra situação comum ao trabalhar com dados é obter totais e médias. Felizmente também temos operações que permitem resolver este problema, `sum` e `mean` respectivamente. Por exemplo:
